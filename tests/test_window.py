...
class TestWindow(unittest.TestCase):
    def test_window_creation(self):
        ...
        window1 = image.AP_Window((0,6), (100,100))
        ...
        self.assertEqual(window1.center[1], 56., "Window should determine center")
    ...
    def test_window_arithmetic(self):
        ...
        self.assertEqual(big_or_offset.shape[1], 120, "logical or of images should take largest bounding box")
        self.assertEqual(windowbig.origin[0], 0, "logical or of images should not affect initial images")
        self.assertEqual(windowbig.shape[0], 100, "logical or of images should not affect initial images")
        ...
        self.assertEqual(big_and_offset.shape[1], 80, "logical and of images should take overlap region")
        self.assertEqual(windowbig.origin[0], 0, "logical and of images should not affect initial images")
        self.assertEqual(windowbig.shape[0], 100, "logical and of images should not affect initial images")
        ...
        self.assertEqual(windowbig.shape[1], 120, "logical or of images should take largest bounding box")
        ...
        self.assertEqual(windowbig.shape[1], 80, "logical and of images should take overlap region")
