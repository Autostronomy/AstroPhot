...
These should automatically be installed along with AutoProf:
...
If you wish to help develop AutoProf, thank you! You can get started by forking the repository then cloning it to your device::
