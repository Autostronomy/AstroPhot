...
class iKingPSFMixin:
    ...
    **Parameters:**
    ...
    _model_type = "king"
    _parameter_specs = {
        "Rc": {"units": "pix", "valid": (0.0, None), "shape": (None,), "dynamic": True},
        "Rt": {"units": "pix", "valid": (0.0, None), "shape": (None,), "dynamic": True},
        "alpha": {"units": "unitless", "valid": (0, 10), "shape": (None,), "dynamic": False},
        "I0": {"units": "flux/pix^2", "valid": (0, None), "shape": (None,), "dynamic": False},
    }
