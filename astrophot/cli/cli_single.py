...
def main():
    ...
    parser.add_argument(
        "--name", type=str, default="astrophot_model", help="Name used for saving files"
    )
    ...
    if args.dump:
        with open("single_astrophot_model.py", "w", encoding="utf-8") as f:
            f.write(
                "# This file was generated by dumping the single_model_cli.py script. You can edit and run this file directly.\n\n"
            )
            with open(__file__, "r", encoding="utf-8") as original:
                f.write(original.read())
        print("Dumped to single_astrophot_model.py")
